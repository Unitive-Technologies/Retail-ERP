    ...
    <>
      ...
      >
        <PageHeader
          ...
          navigateUrl="/admin/purchases/purchase"
          showCreateBtn={false}
          showlistBtn={true}
        ...
        >
          ...
          <Grid container padding="20px">
            <Grid size={{ xs: 12, md: 6 }} sx={styles.leftItem}>
              <TextInput
                inputLabel="Purchase Order NO"
                value={edit.getValue('purchase_order_no')}
                onChange={(e: any) =>
                  handleValidatedChange(e, edit, 'purchase_order_no', 'string')
                }
            ...
            <Grid size={{ xs: 12, md: 6 }} sx={styles.rightItem}>
              <TextInput
                ...
                onChange={(e: any) =>
                  handleValidatedChange(e, edit, 'vendor_id', 'string')
                }
                //  isError={nameError}
                {...commonTextInputProps}
              />
