...
export const voucherRows = [
  {
    id: 1,
    payment_date: '02/05/2025',
    payment_no: 'PAY 01/24-25',
  ...
  },
  {
    ...
    payment_no: 'PAY 02/24-25',
    account_name: 'Shiva Silver Suppliers',
    total_amount: 25000,
  },
  {
    id: 3,
    payment_date: '08/05/2025',
    payment_no: 'PAY 03/24-25',
    account_name: 'Jai Shree Jewels',
    total_amount: 20475,
  },
  {
    id: 4,
    payment_date: '10/05/2025',
    payment_no: 'PAY 04/24-25',
    ...
    <>
      <Grid container width={'100%'} mt={1.2}>
        <PageHeader
          ...
          navigateUrl="/admin/voucher/create"
        />
