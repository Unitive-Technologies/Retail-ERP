...
import { revenueData } from '@constants/DummyData';
      ...
      renderCell: ({ row }: { row: any }) => {
        ...
        return (
          <MUHListItemCell
            ...
            isLink={`/admin/revenue/branch?branchId=${row.id}&branchName=${row.branch_name}`}
          />
        );
      },
    },
